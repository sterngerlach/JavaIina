...
public class Reservation {
    ...
    public Reservation(Member member, RentalObject rentalObject, LocalDate reservationDate, boolean done) {
        this.mMember = member;
    ...
    public String toString() {
        return String.format("Reservation[Member ID: %s, RentalObject ID: %s," +
                             "Reservation Date: %s, Done: %s]"
                             ,this.mMember.id(), this.mRentalObject.id(), this.mReservationDate, this.mDone);
    }
}
